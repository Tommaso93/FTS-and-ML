...
# inputfile = os.path.join(working_path, "../../../data/20160629_fts_message_sample.json")
...
def jsonListToCSV(jsonList, keysSet, outputPath, hash_f=False ):
    ...
    csvwriter = csv.DictWriter(outputhFile, fieldnames=keysSet, restval=cvs_field_ph, lineterminator='\n')
